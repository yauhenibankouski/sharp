...
DESECRIPTIONS = [
  ...
  'A dumbbell pullover is a weighted exercise that usually involves a workout bench.
  The pullover motion involves holding the dumbbell in your hand, and moving it from in front of you to behind you, over your head',
  'The barbell shrug exercise is performed to target and build strong traps.',

  'The bench press is a compound exercise that involves the pectoralis major of the chest, the anterior deltoids of the shoulder,
  and the triceps brachii of the upper arm. 1 It builds strength as well as encouraging the growth (hypertrophy) of these muscles.',
  'The dumbbell chest fly is an upper body exercise that works muscle groups in your chest, shoulders, and arms.',
...
TECHNIQUE = [
  ...
  'Tighten your abs and firmly grasp the barbell with an overhand grip.
  ...
  'Grip a barbell with hands slightly wider than shoulder width. The bar should be directly over the shoulders.
  ...
  'Select the weight for the machine.
  Sit on the platform. Press your back firmly against the back of the platform with your feet flat on the floor.
  Grab one handle of the machine with each hand.
  Depending on the model, the pec deck may have a resting pad.
  If so, place your forearms on each pad. Bend your arms at a 90° angle and keep your elbows at chest level.
  Gripping the pec deck handles, pull your arms toward your body while contracting your pectoral muscles.
  Bring the handles or arm pads in front of your chest, hold the position for a couple of seconds, and then slowly release back to starting position.',
